...
public class IotCameraView  extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public IotCameraView(Context context, Camera camera){
        super(context);
        mCamera=camera;
    ...
    public IotCameraView(Context context) {
        super(context);
    }
